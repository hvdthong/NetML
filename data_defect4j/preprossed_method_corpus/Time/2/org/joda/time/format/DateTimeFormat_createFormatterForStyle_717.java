...
select format charact style pattern charact
date style charact time style
charact 's' style 'm' medium 'l' 'f'
full date time ommit style charact

param style charact set
illeg argument except illegalargumentexcept style invalid

date time formatt datetimeformatt creat formatt style createformatterforstyl string style
style style length
illeg argument except illegalargumentexcept invalid style specif style

date style datestyl select style selectstyl style charat
time style timestyl select style selectstyl style charat
date style datestyl time style timestyl
illeg argument except illegalargumentexcept style invalid

creat formatt style index createformatterforstyleindex date style datestyl time style timestyl
