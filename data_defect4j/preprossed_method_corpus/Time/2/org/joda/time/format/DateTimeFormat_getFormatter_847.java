...
date time formatt datetimeformatt formatt getformatt local local
local local local default getdefault local
string kei integ string tostr type ityp date style idatestyl time style itimestyl local string tostr
date time formatt datetimeformatt
cach ccach
cach ccach kei

string pattern pattern getpattern local
date time format datetimeformat pattern forpattern pattern
cach ccach put kei
