...
string pattern style patternforstyl string style local local
date time formatt datetimeformatt formatt creat formatt style createformatterforstyl style
local
local local default getdefault

pretti work
style formatt styleformatt formatt printer getprint pattern getpattern local
