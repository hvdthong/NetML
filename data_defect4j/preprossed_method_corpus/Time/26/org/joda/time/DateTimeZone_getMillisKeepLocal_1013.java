...
millisecond instant zone keep local time

convers perform convert utc milli local
milli zone convert back utc milli zone

param zone newzon zone mean
param instant oldinst utc millisecond instant convert
utc millisecond instant local time zone

milli local getmilliskeeploc date time zone datetimezon zone newzon instant oldinst
zone newzon
zone newzon date time zone datetimezon default getdefault

zone newzon
instant oldinst

instant local instantloc instant oldinst offset getoffset instant oldinst
instant local instantloc zone newzon offset local getoffsetfromloc instant local instantloc
