...
return date time datetim field set minimum
field

offset utc retain applic
call link date time datetim earlier offset overlap withearlieroffsetatoverlap result
forc earlier time dst overlap desir
...
copi date time datetim field set minimum


date time datetim minimum withminimumvalu
...
subtract milli dai perfect work situat
gap aftergap chronolog getchronolog zone getzon transit nexttransit milli getmilli date time constant datetimeconst milli dai
date time datetim gap aftergap chronolog getchronolog
