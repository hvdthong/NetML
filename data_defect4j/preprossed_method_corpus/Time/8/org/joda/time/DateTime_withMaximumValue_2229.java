...
return date time datetim field set maximum
field

oper obtain date time datetim dai
month month length vari
pre
date time datetim dai month lastdayofmonth dai month dayofmonth maximum withmaximumvalu
pre

offset utc retain applic
call link date time datetim offset overlap withlateroffsetatoverlap result
forc time dst overlap desir

method handl daylight sva time gap set
time instant gap

date time datetim attach properti unchang call

copi date time datetim field set maximum


date time datetim maximum withmaximumvalu

set copi setcopi maximum getmaximumvalu
runtim except runtimeexcept
illeg instant except illegalinstantexcept illeg instant isillegalinst
ad milli dai perfect work situat
gap beforegap chronolog getchronolog zone getzon previou transit previoustransit milli getmilli date time constant datetimeconst milli dai
date time datetim gap beforegap chronolog getchronolog
