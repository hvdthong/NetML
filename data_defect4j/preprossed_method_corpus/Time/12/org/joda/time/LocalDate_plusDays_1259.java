...
line ident effect
pre
local date locald ad dai plusdai
local date locald ad period dai
local date locald ad field ad withfieldad durat field type durationfieldtyp dai
pre

param dai amount dai add neg
local date locald increas dai

local date locald dai plusdai dai
dai
