...
print readabl period readableperiod string buffer stringbuff

param buf format period append buffer
param period period format

print printto string buffer stringbuff buf readabl period readableperiod period
check printer checkprint
check period checkperiod period

printer getprint print printto buf period local ilocal
