...
pars code local date locald string formatt

param str string pars
param formatt formatt


local date locald pars string str date time formatt datetimeformatt formatt
formatt pars local date parselocald str
