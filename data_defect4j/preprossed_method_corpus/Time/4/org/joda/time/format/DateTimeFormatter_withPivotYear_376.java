...
return formatt pivot year
digit year pars prefer store parser

set chang pivot year format built
pattern link date time format datetimeformat pattern forpattern string

pars pivot year null mean overrid
effect print

pivot year enabl digit year convert
digit year pivot repres year middl
support rang year full rang year
built code pivot pivot code
...
param pivot year pivotyear pivot year overrid pars
formatt


date time formatt datetimeformatt pivot year withpivotyear integ pivot year pivotyear
pivot year ipivotyear pivot year pivotyear pivot year ipivotyear pivot year ipivotyear equal pivot year pivotyear


date time formatt datetimeformatt printer iprint parser ipars local ilocal
offset pars ioffsetpars chrono ichrono zone izon pivot year pivotyear default year idefaultyear
