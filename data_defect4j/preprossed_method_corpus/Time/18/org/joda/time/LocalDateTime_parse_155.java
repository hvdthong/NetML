...
pars code local date time localdatetim string

link iso date time format isodatetimeformat local date option time parser localdateoptionaltimepars

param str string pars


string fromstr
local date time localdatetim pars string str
pars str iso date time format isodatetimeformat local date option time parser localdateoptionaltimepars
