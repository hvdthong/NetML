...
line ident effect
pre
local date locald subtract minu dai minusdai
local date locald subtract minu period dai
local date locald subtract field ad withfieldad durat field type durationfieldtyp dai
pre

param dai amount dai subtract neg
local date locald minu increas dai

local date locald minu dai minusdai dai
dai
