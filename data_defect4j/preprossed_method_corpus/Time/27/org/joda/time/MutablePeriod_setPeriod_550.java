...
set field durat divid
field period type

divid durat precis field period type
larg durat remain durat store largest
precis field

param durat durat set mean length
param chrono chronolog mean iso
arithmet except arithmeticexcept set exce capac period

set period setperiod readabl durat readabledur durat chronolog chrono
durat milli durationmilli date time util datetimeutil durat milli getdurationmilli durat
set period setperiod durat milli durationmilli chrono
