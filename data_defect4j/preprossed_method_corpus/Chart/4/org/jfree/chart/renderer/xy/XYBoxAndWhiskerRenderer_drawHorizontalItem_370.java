...
draw horizont item drawhorizontalitem graphics2 graphics2d item render state xyitemrendererst state
...
fill box fillbox
set paint setpaint lookup box paint lookupboxpaint seri item
fill box
...
averag yaverag
radiu aradiu width
check averag marker fact visibl
draw
averag yyaverag data area dataarea min getminx radiu aradiu
averag yyaverag data area dataarea max getmaxx radiu aradiu
...
add entiti addent entiti box dataset seri item select
averag yyaverag
