...
compar group
seri group map seriestogroupmap group getgroup dataset row kei getrowkei row
plot orient plotorient orient plot orient getorient
bar barw0 calcul bar calculatebarw0
plot orient data area dataarea domain axi domainaxi
state row column
