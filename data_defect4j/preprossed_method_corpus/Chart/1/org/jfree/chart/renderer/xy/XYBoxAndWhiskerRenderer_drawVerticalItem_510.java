...
draw vertic item drawverticalitem graphics2 graphics2d item render state xyitemrendererst state
...
draw
averag yyaverag data area dataarea min getmini radiu aradiu
averag yyaverag data area dataarea max getmaxi radiu aradiu
