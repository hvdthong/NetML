...
code reflect string builder reflectiontostringbuild code gener
code string tostr code object

param type object
param object object output
param style style code string tostr code creat code code
param output transient outputtransi includ field
param reflect class reflectuptoclass superclass reflect inclus code code
string result
reflect string builder reflectiontostringbuild string tostr object string style tostringstyl class


string reflect string reflectiontostr
object
string style tostringstyl style
output transient outputtransi
class reflect class reflectuptoclass
reflect string builder reflectiontostringbuild string tostr object style output transient outputtransi reflect class reflectuptoclass
