...
resolv sourc string templat

portion string process
rest string process return

param sourc string replac return
param offset start offset arrai valid
param length length arrai process valid
result replac oper

string replac string sourc offset length
sourc


str builder strbuilder buf str builder strbuilder length append sourc offset length
substitut buf length
sourc substr offset offset length
