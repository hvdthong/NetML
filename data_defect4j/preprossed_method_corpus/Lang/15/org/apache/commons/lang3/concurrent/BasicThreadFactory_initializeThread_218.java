...
initi thread method call
link thread newthread runnabl thread obtain
wrap thread factori initi thread
option set factori

param thread initi

initi thread initializethread thread

name pattern getnamingpattern
long count long valueof thread counter threadcount increment incrementandget
set setnam string format name pattern getnamingpattern count


uncaught except handler getuncaughtexceptionhandl
set uncaught except handler setuncaughtexceptionhandl uncaught except handler getuncaughtexceptionhandl


prioriti getprior
set prioriti setprior prioriti getprior intvalu


daemon flag getdaemonflag
set daemon setdaemon daemon flag getdaemonflag booleanvalu
