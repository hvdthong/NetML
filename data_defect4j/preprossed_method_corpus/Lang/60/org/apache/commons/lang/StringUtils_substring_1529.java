...
neg start posit start end code code
charact end string

return substr start charact code start code
posit end code end code posit posit count
base start begin string
code start code neg start end posit
offset rel end string

code start code strictli left code end code
return
...
count back end string charact
substr start posit end positon
