...
append object builder pad left fix width
code string tostr code object
object larger length left hand side lost
object text

param obj object append text
param width fix field width neg effect
param pad char padchar pad charact
enabl chain

str builder strbuilder append fix width pad left appendfixedwidthpadleft object obj width pad char padchar
width
ensur capac ensurecapac size width
string str obj null text getnulltext obj string tostr
str
str

str len strlen str length
str len strlen width
str char getchar str len strlen width str len strlen buffer size

pad len padlen width str len strlen
pad len padlen
buffer size pad char padchar

str char getchar str len strlen buffer size pad len padlen
