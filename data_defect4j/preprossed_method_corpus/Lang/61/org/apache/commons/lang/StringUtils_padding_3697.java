...
return pad delimit repeat
length

pre
string util stringutil pad 'e'
string util stringutil pad 'e' eee
string util stringutil pad 'e' index bound except indexoutofboundsexcept
pre

note method support pad
href http www unicod org glossari supplementari charact unicod supplementari charact
requir pair code code repres
need support full i18 i18n applic
link repeat string


param repeat number time repeat delim
param pad char padchar charact repeat
string repeat charact
index bound except indexoutofboundsexcept code repeat code
repeat string

string pad repeat pad char padchar index bound except indexoutofboundsexcept
repeat
index bound except indexoutofboundsexcept pad neg amount repeat

buf repeat
buf length
buf pad char padchar
