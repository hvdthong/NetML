...
code len code charact middl string

code len code charact remaind
string return except
string code code code code return
except thrown len neg
...
param len length requir string posit
middl charact code code string input
