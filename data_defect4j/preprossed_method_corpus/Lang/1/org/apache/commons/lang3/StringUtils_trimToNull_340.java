...
end string return code string
empti trim code

string trim link string trim
trim remov start end charact
strip whitespac link strip null striptonul string

pre
string util stringutil trim null trimtonul
string util stringutil trim null trimtonul
string util stringutil trim null trimtonul
string util stringutil trim null trimtonul abc abc
string util stringutil trim null trimtonul abc abc
pre

param str string trim
trim string
code char empti string input


string trim null trimtonul string str
string trim str
empti isempti
