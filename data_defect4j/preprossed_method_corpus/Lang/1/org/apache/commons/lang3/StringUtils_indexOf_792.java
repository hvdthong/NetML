...
handl code
method link string index indexof

code empti char sequenc charsequ code index found
neg start posit treat
start posit greater string length return code

pre
string util stringutil index indexof
string util stringutil index indexof
string util stringutil index indexof aabaabaa 'b'
string util stringutil index indexof aabaabaa 'b'
string util stringutil index indexof aabaabaa 'b'
string util stringutil index indexof aabaabaa 'b'
pre
...
chang signatur index indexof string index indexof char sequenc charsequ

index indexof char sequenc charsequ seq search char searchchar start po startpo
empti isempti seq
index found

char sequenc util charsequenceutil index indexof seq search char searchchar start po startpo
