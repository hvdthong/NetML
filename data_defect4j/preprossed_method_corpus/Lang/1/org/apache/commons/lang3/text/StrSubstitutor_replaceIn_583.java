...
replac occurr variabl sourc builder
match valu resolv
builder updat result

portion buffer process
rest buffer process delet

param sourc buffer replac updat return
param offset start offset arrai valid
param length length buffer process valid
alter


replac replacein string builder stringbuild sourc offset length
sourc


str builder strbuilder buf str builder strbuilder length append sourc offset length
substitut buf length


sourc replac offset offset length buf string tostr
