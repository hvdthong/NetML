...
check variabl stack list variabl

param var varnam variabl check
param prior variabl priorvari list prior variabl

check cyclic substitut checkcyclicsubstitut string var varnam list string prior variabl priorvari
prior variabl priorvari var varnam


str builder strbuilder buf str builder strbuilder
buf append infinit loop properti interpol
buf append prior variabl priorvari remov
buf append
buf append separ appendwithsepar prior variabl priorvari
illeg state except illegalstateexcept buf string tostr
