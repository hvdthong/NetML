...
count time substr appear larger string

code empti string input return code

pre
string util stringutil count match countmatch
string util stringutil count match countmatch
string util stringutil count match countmatch abba
string util stringutil count match countmatch abba
string util stringutil count match countmatch abba
string util stringutil count match countmatch abba
string util stringutil count match countmatch abba xxx
pre

param str char sequenc charsequ check
param substr count
number occurr char sequenc charsequ code
chang signatur count match countmatch string string count match countmatch char sequenc charsequ char sequenc charsequ

count match countmatch char sequenc charsequ str char sequenc charsequ
empti isempti str empti isempti


count
idx
idx char sequenc util charsequenceutil index indexof str idx index found
count
idx length
