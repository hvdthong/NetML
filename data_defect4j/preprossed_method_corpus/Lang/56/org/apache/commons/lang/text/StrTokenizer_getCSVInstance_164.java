...
token instanc pars comma seper string
initi input csv process
trim whitespac end overriden
set trimmer settrimm method

param input text pars
token instanc pars comma seper string

str token strtoken csv instanc getcsvinst string input
str token strtoken tok csv clone getcsvclon
tok reset input
tok
