...
creat token current content builder

method content builder token
token setup token space tab newlin
formfe string token stringtoken valu chang
token retriev token

note intern charact arrai share
object synchron occur call method
complet token alter buffer

str token strtoken instanc

str token strtoken token astoken
str token strtoken buffer
