...
remov
suppli string string

param str string chomp
param sep string chomp
string prechomp
null pointer except nullpointerexcept str sep code code
deprec link substr substringbefor string string
includ separ
method remov common lang

string prechomp getprechomp string str string sep
idx str index indexof sep
idx
str substr idx sep length
