...
constructor code string builder tostringbuild code

style code code style

buffer code code creat

param object object build code string tostr code
param style style code string tostr code creat
code code
param buffer code string buffer stringbuff code popul
code code

string builder tostringbuild object object string style tostringstyl style string buffer stringbuff buffer
style
style default style getdefaultstyl
...
style append start appendstart buffer object
