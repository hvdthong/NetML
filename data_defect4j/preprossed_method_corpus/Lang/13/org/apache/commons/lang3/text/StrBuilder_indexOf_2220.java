...
index indexof string str start index startindex
start index startindex start index startindex start index startindex
str start index startindex size


str len strlen str length
str len strlen
index indexof str charat start index startindex
...
buf thisbuf buffer
len size str len strlen
outer
start index startindex len
str len strlen
str charat buf thisbuf
outer
