...
search string builder matcher find
match search index

matcher perform advanc search behaviour
write matcher find charact 'a'
number

param matcher matcher return
param start index startindex index start invalid index round edg
index match found

index lastindexof str matcher strmatcher matcher start index startindex
start index startindex start index startindex size size start index startindex
matcher start index startindex


buf buffer
end index endindex start index startindex
start index startindex
matcher match ismatch buf end index endindex
