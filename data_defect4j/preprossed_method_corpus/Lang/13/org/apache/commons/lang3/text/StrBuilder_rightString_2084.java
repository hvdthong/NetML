...
extract rightmost charact string builder
throw except

method extract code length code charact
builder charact
builder return return string shorter
length request

param length number charact extract neg return empti string
string

string string rightstr length
length

length size
string buffer size

string buffer size length length
