...
param str string insert
enabl chain
index bound except indexoutofboundsexcept index invalid

suppress warn suppresswarn str
str builder strbuilder insert index string str
valid index validateindex index
str
str text nulltext

str len strlen str str length
str len strlen
size newsiz size str len strlen
ensur capac ensurecapac size newsiz
system arraycopi buffer index buffer index str len strlen size index
size size newsiz
str char getchar str len strlen buffer index str
