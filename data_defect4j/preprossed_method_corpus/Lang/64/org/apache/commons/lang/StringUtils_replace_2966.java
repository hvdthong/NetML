...
param repl string search
param string replac
param max maximum number valu replac code code maximum
text replac process
code code string input

string replac string text string repl string max
empti isempti text empti isempti repl max
text

start
end text index indexof repl start
end
text

repl length repllength repl length
increas length repl length repllength
increas increas increas
increas max max max
string buffer stringbuff buf string buffer stringbuff text length increas
end
buf append text substr start end append
