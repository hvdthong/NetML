...
intern method perform token

user call method method
call automat method requir

method exist subclass add code
token subclass alter charact arrai
offset count pars call token multipl time
multipl string filter result

code str token strtoken code pass offset count
equal length arrai method subclass
pass valu arrai

param char charact arrai token
param offset start posit charact arrai valid
param count number charact token valid
modifi list string token unmodifi arrai count

list token char offset count
char count
collect empti list
...
po po count
find token
po read token readnexttoken char po count buf token
