...
code split preserv token splitpreservealltoken method maximum arrai
length

param str string pars code
param separ char separatorchar separ charact
param max maximum number element includ
...
string split worker splitwork string str string separ char separatorchar max preserv token preservealltoken
perform tune jdk1
direct code quicker string token stringtoken
string token stringtoken space isspac whitespac iswhitespac
...
size plus1 sizeplus1
start
match
match lastmatch
separ char separatorchar
null separ mean whitespac
len
charact whitespac iswhitespac str charat
match preserv token preservealltoken
match lastmatch
size plus1 sizeplus1 max
len
match lastmatch
...
separ char separatorchar length
optimis charact
sep separ char separatorchar charat
len
str charat sep
match preserv token preservealltoken
match lastmatch
...
standard
len
separ char separatorchar index indexof str charat
match preserv token preservealltoken
match lastmatch
size plus1 sizeplus1 max
len
