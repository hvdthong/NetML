...
replac occurr variabl sourc object
match valu map method specifii
custom variabl prefix suffix

param sourc sourc text variabl substitut return
param map valuemap map valu
param prefix prefix variabl
param suffix suffix variabl
result replac oper
illeg argument except illegalargumentexcept prefix suffix

string replac object sourc map string map valuemap string prefix string suffix
str substitutor strsubstitutor map valuemap prefix suffix replac sourc
