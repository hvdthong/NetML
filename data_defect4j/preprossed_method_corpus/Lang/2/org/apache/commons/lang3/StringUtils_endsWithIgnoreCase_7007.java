...
case insensit check char sequenc charsequ end suffix

code handl except code
refer consid equal comparison insensit

pre
string util stringutil end ignor case endswithignorecas
string util stringutil end ignor case endswithignorecas def
string util stringutil end ignor case endswithignorecas abcdef
string util stringutil end ignor case endswithignorecas abcdef def
string util stringutil end ignor case endswithignorecas abcdef def
string util stringutil end ignor case endswithignorecas abcdef cde
pre

java lang string end endswith string
param str char sequenc charsequ check
param suffix suffix find
code char sequenc charsequ end suffix insensit
code

chang signatur end ignor case endswithignorecas string string end ignor case endswithignorecas char sequenc charsequ char sequenc charsequ

end ignor case endswithignorecas char sequenc charsequ str char sequenc charsequ suffix
end endswith str suffix
