...
replac portion string builder string
length insert string match remov length
...
param replac str replacestr string replac mean delet rang
enabl chain
index bound except indexoutofboundsexcept index invalid

str builder strbuilder replac start index startindex end index endindex string replac str replacestr
end index endindex valid rang validaterang start index startindex end index endindex
insert len insertlen replac str replacestr replac str replacestr length
replac impl replaceimpl start index startindex end index endindex end index endindex start index startindex replac str replacestr insert len insertlen
