...
set name pattern code
basic thread factori basicthreadfactori

param pattern name pattern
refer code builder
null pointer except nullpointerexcept name pattern

builder name pattern namingpattern string pattern
pattern
null pointer except nullpointerexcept
name pattern


name pattern namingpattern pattern
