...
creat instanc code thread factori impl threadfactoryimpl configur
code builder object

param builder code builder object

basic thread factori basicthreadfactori builder builder
builder wrap factori wrappedfactori
wrap factori wrappedfactori executor thread factori defaultthreadfactori

wrap factori wrappedfactori builder wrap factori wrappedfactori


name pattern namingpattern builder name pattern namingpattern
prioriti builder prioriti
daemon flag daemonflag builder daemon flag daemonflag
uncaught except handler uncaughtexceptionhandl builder except handler exceptionhandl

thread counter threadcount atom long atomiclong
