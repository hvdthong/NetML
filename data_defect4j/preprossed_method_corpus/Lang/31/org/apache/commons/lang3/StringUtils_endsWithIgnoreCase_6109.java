...
case insensit check string end suffix

code code handl except code code
...
code code string end suffix insensit
code code


end ignor case endswithignorecas string str string suffix
