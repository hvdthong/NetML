...
creat instanc token instanc reset
start token list

instanc token reset
clone support except clonenotsupportedexcept problem clone

object clone reset clonereset clone support except clonenotsupportedexcept
method exist enabl test coverag
str token strtoken clone str token strtoken clone
clone char
clone char clone char clone
