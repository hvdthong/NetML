...
strip set charact start end string
similar link string trim charact
strip control
...
altern link strip string

pre
string util stringutil strip
string util stringutil strip
string util stringutil strip abc abc
string util stringutil strip abc abc
string util stringutil strip abc abc
string util stringutil strip abc abc
string util stringutil strip abcyx xyz abc
pre
...
string strip string str string strip char stripchar
empti isempti str
str

str strip start stripstart str strip char stripchar
strip end stripend str strip char stripchar
