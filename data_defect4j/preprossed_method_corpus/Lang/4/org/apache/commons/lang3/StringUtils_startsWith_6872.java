...
check char sequenc charsequ start prefix

code handl except code
refer consid equal comparison sensit

pre
string util stringutil start startswith
string util stringutil start startswith abc
string util stringutil start startswith abcdef
string util stringutil start startswith abcdef abc
string util stringutil start startswith abcdef abc
pre
...
code char sequenc charsequ start prefix sensit
code

chang signatur start startswith string string start startswith char sequenc charsequ char sequenc charsequ

start startswith char sequenc charsequ str char sequenc charsequ prefix
