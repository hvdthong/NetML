...
check char sequenc charsequ end suffix

code handl except code
refer consid equal comparison sensit

pre
string util stringutil end endswith
string util stringutil end endswith def
string util stringutil end endswith abcdef
string util stringutil end endswith abcdef def
string util stringutil end endswith abcdef def
string util stringutil end endswith abcdef cde
pre

java lang string end endswith string
param str char sequenc charsequ check
param suffix suffix find
code char sequenc charsequ end suffix sensit
code

chang signatur end endswith string string end endswith char sequenc charsequ char sequenc charsequ

end endswith char sequenc charsequ str char sequenc charsequ suffix
