...
check char sequenc charsequ charact set charact



code char sequenc charsequ code code search char sequenc charsequ
code
...
string util stringutil containsani
string util stringutil containsani
string util stringutil containsani zzabyycdxx
string util stringutil containsani zzabyycdxx
string util stringutil containsani aba
pre

param
char sequenc charsequ check
param search char searchchar
char search
code char found code match input

chang signatur containsani string string containsani char sequenc charsequ char sequenc charsequ

containsani char sequenc charsequ char sequenc charsequ search char searchchar
search char searchchar


containsani char sequenc util charsequenceutil char arrai tochararrai search char searchchar
