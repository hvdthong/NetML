...
string util stringutil substr substringbetween tagabctag
string util stringutil substr substringbetween tagabctag
string util stringutil substr substringbetween tagabctag tag abc
pre

param str string substr
param tag string substr
substr code match


string substr substringbetween string str string tag
