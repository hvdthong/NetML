...
leftmost code len charact string

code len charact
string code string return
except empti string return len neg

pre
string util stringutil left
string util stringutil left
string util stringutil left
string util stringutil left abc
string util stringutil left abc
string util stringutil left abc abc
pre

param str string leftmost charact
param len length requir string
leftmost charact code string input

string left string str len
str
