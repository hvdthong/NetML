...
pre
string util stringutil overlai string overlaystr null pointer except nullpointerexcept
string util stringutil overlai string overlaystr null pointer except nullpointerexcept
string util stringutil overlai string overlaystr abc abc
string util stringutil overlai string overlaystr abcdef abef
string util stringutil overlai string overlaystr abcdef abef
string util stringutil overlai string overlaystr abcdef zzzz abzzzzef
string util stringutil overlai string overlaystr abcdef zzzz abcdzzzzcdef
string util stringutil overlai string overlaystr abcdef zzzz index bound except indexoutofboundsexcept
string util stringutil overlai string overlaystr abcdef zzzz index bound except indexoutofboundsexcept
pre

param text string overlai
param overlai string overlai
param start posit start overlai valid
param end posit stop overlai valid
overlai string code code string input
null pointer except nullpointerexcept text overlai
index bound except indexoutofboundsexcept posit invalid
deprec name link overlai string string
method remov common lang

string overlai string overlaystr string text string overlai start end
string buffer stringbuff start overlai length text length end
append text substr start
append overlai
append text substr end
string tostr
