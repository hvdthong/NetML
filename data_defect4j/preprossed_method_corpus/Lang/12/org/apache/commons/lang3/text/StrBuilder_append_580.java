...
append part string buffer string builder
...
str builder strbuilder append string buffer stringbuff str start index startindex length
str
append null appendnul

start index startindex start index startindex str length
string index bound except stringindexoutofboundsexcept start index startindex valid

length start index startindex length str length
string index bound except stringindexoutofboundsexcept length valid

length
len length
ensur capac ensurecapac len length
str char getchar start index startindex start index startindex length buffer len
size length
