...
extract portion string builder string

note method treat end index endindex greater length
builder equal length builder continu
error unlik string buffer stringbuff string
...
string substr start index startindex end index endindex
end index endindex valid rang validaterang start index startindex end index endindex
string buffer start index startindex end index endindex start index startindex
