...
updat length builder drop charact
ad filler unicod

param length length set posit
enabl chain
index bound except indexoutofboundsexcept length neg

str builder strbuilder set length setlength length
length
string index bound except stringindexoutofboundsexcept length

length size
size length
length size
ensur capac ensurecapac length
end oldend size
end newend length
size length
end oldend end newend
buffer
