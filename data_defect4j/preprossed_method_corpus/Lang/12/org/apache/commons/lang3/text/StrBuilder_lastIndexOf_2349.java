...
search string builder find refer
string start search index

note input string jdk except

param str string find return
param start index startindex index start invalid index round edg
index string found

index lastindexof string str start index startindex
start index startindex start index startindex size size start index startindex
str start index startindex


str len strlen str length
str len strlen str len strlen size
str len strlen
index lastindexof str charat start index startindex


outer
start index startindex str len strlen
str len strlen
str charat buffer
outer
