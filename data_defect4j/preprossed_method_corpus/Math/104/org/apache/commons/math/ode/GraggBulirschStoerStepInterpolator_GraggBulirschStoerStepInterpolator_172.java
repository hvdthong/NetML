...
simpl constructor
param refer integr arrai hold current state
param dot y0dot refer integr arrai hold slope
begin step
param refer integr arrai hold state
end step
param dot y1dot refer integr arrai hold slope
theend step
param mid dot ymiddot refer integr arrai hold
deriv middl point step
param forward integr direct indic

gragg bulirsch stoer step interpol graggbulirschstoerstepinterpol dot y0dot
dot y1dot
mid dot ymiddot
forward
...
dot y1dot dot y1dot
mid dot ymiddot mid dot ymiddot

reset tabl resett mid dot ymiddot length
