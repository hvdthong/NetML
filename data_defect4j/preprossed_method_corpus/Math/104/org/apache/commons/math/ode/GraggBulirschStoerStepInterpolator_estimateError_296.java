...
estim interpol error
param scale scale arrai
estim interpol error

estim error estimateerror scale
error
current degre currentdegre
current state currentst length
polynom current degre currentdegre scale
error

error math sqrt error current state currentst length errfac current degre currentdegre
