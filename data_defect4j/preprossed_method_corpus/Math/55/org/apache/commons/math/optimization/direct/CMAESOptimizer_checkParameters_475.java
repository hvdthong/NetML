...
boundari
boundari length
multi dimens mismatch except multidimensionmismatchexcept
integ boundari length
integ
boundari boundari
data except nodataexcept
boundari length init length
multi dimens mismatch except multidimensionmismatchexcept
integ boundari length
integ init length
boundari length init length
...
integ init length
init length
boundari init boundari init
rang except outofrangeexcept init boundari
boundari
...
multi dimens mismatch except multidimensionmismatchexcept
integ input sigma inputsigma length
integ init length
init length
input sigma inputsigma
...
boundari
input sigma inputsigma
rang except outofrangeexcept input sigma inputsigma
