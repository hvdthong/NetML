...
polynomi spline function polynomialsplinefunct
...
illeg argument except illegalargumentexcept knot length
code polynomi length knot length code knot arrai
strictli increas
...
local format localizedformat point spline partit
knot length

knot length polynomi length
math runtim except mathruntimeexcept creat illeg argument except createillegalargumentexcept
local format localizedformat polynomi interpol mismatch segment
polynomi length knot length

strictli increas isstrictlyincreas knot
math runtim except mathruntimeexcept creat illeg argument except createillegalargumentexcept
local format localizedformat strictli increas knot valu
