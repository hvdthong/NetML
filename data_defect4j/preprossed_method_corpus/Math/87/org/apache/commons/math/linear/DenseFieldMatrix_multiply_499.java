...
multipli dens field matrix densefieldmatrix
class cast except classcastexcept cce

safeti check
check multipl compat checkmultiplicationcompat

dens field matrix densefieldmatrix dens field matrix densefieldmatrix field getfield row column dimens getcolumndimens
...
end qend math min start qstart block size column dimens getcolumndimens
...
sum
start lstart start rstart end lend
