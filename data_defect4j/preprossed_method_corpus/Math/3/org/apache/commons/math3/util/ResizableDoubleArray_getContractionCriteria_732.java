...
contract criteria defin intern arrai contract
store number element element arrai
code expans mode expansionmod code code multipl mode code
contract trigger ratio storag arrai length
code num element numel code exce code contract factor contractionfactor code
code expans mode expansionmod code code addit mode code
number excess storag locat compar
code contract factor contractionfactor code

contract criteria reclaim memori
deprec link contract criterion getcontractioncriterion


deprec
contract criteria getcontractioncriteria
contract criterion getcontractioncriterion
