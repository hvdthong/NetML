...
check expans factor contract criterion rais
except contract criterion smaller
expans criterion

param contract criterion check
param expans factor check
number small except numberistoosmallexcept code contract expans
number small except numberistoosmallexcept code contract
number small except numberistoosmallexcept code expans


check contract expand checkcontractexpand contract
expans
number small except numberistoosmallexcept
contract expans
number small except numberistoosmallexcept number small except numberistoosmallexcept contract
context getcontext add messag addmessag local format localizedformat contract criteria smaller expans factor
contract expans
...
contract
number small except numberistoosmallexcept number small except numberistoosmallexcept contract
context getcontext add messag addmessag local format localizedformat contract criteria smaller
contract
...
expans
number small except numberistoosmallexcept number small except numberistoosmallexcept contract
context getcontext add messag addmessag local format localizedformat expans factor smaller
expans
