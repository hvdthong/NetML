...
predict intern state estim time step ahead

param
control vector
dimens mismatch except dimensionmismatchexcept
dimens control vector match

predict real vector realvector dimens mismatch except dimensionmismatchexcept
saniti check

dimens getdimens control matrix controlmatrix column dimens getcolumndimens
...
project state estim ahead priori state
hat xhat hat xhat
state estim stateestim transit matrix transitionmatrix oper state estim stateestim

add control input

state estim stateestim state estim stateestim add control matrix controlmatrix oper


project error covari ahead

error covari errorcovari transit matrix transitionmatrix multipli error covari errorcovari
multipli transit matrix transitionmatrixt
add process model processmodel process nois getprocessnois
