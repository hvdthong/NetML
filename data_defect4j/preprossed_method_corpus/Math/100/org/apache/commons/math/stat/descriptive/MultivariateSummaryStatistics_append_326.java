...
append text represent arrai buffer
param buffer buffer fill
param data data arrai
param prefix text prefix
param separ element separ
param suffix text suffix

append string buffer stringbuff buffer data
string prefix string separ string suffix
