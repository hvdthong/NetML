...
set statist implement
param impl newimpl implement statist
param impl oldimpl implement statist
dimens mismatch except dimensionmismatchexcept arrai dimens
match construct
illeg state except illegalstateexcept data ad


set impl setimpl storeless univari statist storelessunivariatestatist impl newimpl
storeless univari statist storelessunivariatestatist impl oldimpl
dimens mismatch except dimensionmismatchexcept illeg state except illegalstateexcept
check empti checkempti
check dimens checkdimens impl newimpl length
system arraycopi impl newimpl impl oldimpl impl newimpl length
