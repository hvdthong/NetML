...
set contract criteria expand contract doubl arrai expandcontractdoublearrai

param contract criteria contractioncriteria contract criteria
math illeg argument except mathillegalargumentexcept contract criteria contractioncriteria
expans criteria expansioncriteria

set contract criteria setcontractioncriteria contract criteria contractioncriteria math illeg argument except mathillegalargumentexcept
check contract expand checkcontractexpand contract criteria contractioncriteria expans factor getexpansionfactor

contract criteria contractioncriteria contract criteria contractioncriteria
