...
creat instanc properti

throw math illeg argument except mathillegalargumentexcept condit
met

code initi capac initialcapac
code expans factor expansionfactor
code contract criterion contractioncriterion expans factor expansionfactor


param initi capac initialcapac initi size intern storag arrai
param expans factor expansionfactor arrai expand base
paramet
param contract criterion contractioncriterion contract criteria
param expans mode expansionmod expans mode
param data initi content arrai
math illeg argument except mathillegalargumentexcept paramet valid

resiz doubl arrai resizabledoublearrai initi capac initialcapac
expans factor expansionfactor
contract criterion contractioncriterion
...
strictli posit except notstrictlypositiveexcept local format localizedformat initi capac posit
initi capac initialcapac

check contract expand checkcontractexpand contract criterion contractioncriterion expans factor expansionfactor

expans factor expansionfactor expans factor expansionfactor
contract criterion contractioncriterion contract criterion contractioncriterion
expans mode expansionmod expans mode expansionmod
