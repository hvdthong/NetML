...
except estim except estimationexcept decomposit perform

decomposit qrdecomposit estim except estimationexcept

initi
col
permut
norm2
index index jacobian length index col
akk jacobian index
norm2 akk akk
...
col
norm2
diag idiag col permut
index diag idiag index jacobian length index col
aki jacobian index
norm2 aki aki

doubl infinit isinfinit norm2 doubl isnan norm2
estim except estimationexcept unabl perform decomposit jacobian matrix
object integ valueof row integ valueof col
...
diag diagr alpha
jacobian diag kdiag alpha

transform remain column
col
dkp permut
gamma
index diag kdiag index jacobian length index col
