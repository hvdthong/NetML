...
param accept small acceptsmal step smaller minim
silent increas small
step gener except
bound integr step bound reach bound
except number small except numberistoosmallexcept step small accept small acceptsmal

filter step filterstep forward accept small acceptsmal
number small except numberistoosmallexcept

filter filteredh
fast math fastmath ab min step minstep
accept small acceptsmal
filter filteredh forward min step minstep min step minstep

number small except numberistoosmallexcept local format localizedformat minim stepsiz reach integr
min step minstep fast math fastmath ab



filter filteredh max step maxstep
filter filteredh max step maxstep
filter filteredh max step maxstep
filter filteredh max step maxstep
