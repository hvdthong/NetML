...
param desir imag rotat
except math illeg argument except mathillegalargumentexcept norm vector
...
v2v2 norm getnormsq
u1u1 u2u2 v1v1 v2v2
math illeg argument except mathillegalargumentexcept local format localizedformat norm rotat defin vector


normal order v1' v1'
vector3 vector3d fast math fastmath sqrt u1u1 v1v1

adjust order v1' v2' v2' v2'
u1u2 dot product dotproduct
v1v2 dot product dotproduct
...
vector3 vector3d alpha beta

preliminari comput
vector3 vector3d ref uref
vector3 vector3d ref vref
vector3 vector3d su1 v1su1 subtract
vector3 vector3d su2 v2su2 subtract
vector3 vector3d su1 v1su1 cross product crossproduct su2 v2su2
vector3 vector3d cross product crossproduct
dot product dotproduct
plane threshold inplanethreshold
plane threshold inplanethreshold norm getnorm norm getnorm
vector close plane
vector
vector3 vector3d vector3 vector3d cross product crossproduct
vector3 vector3d su3 v3su3 subtract
su1 v1su1 cross product crossproduct su3 v3su3
vector3 vector3d prime u2prim cross product crossproduct
dot product dotproduct prime u2prim

plane threshold inplanethreshold norm getnorm prime u2prim norm getnorm
vector close plane
align
su2 v2su2 cross product crossproduct su3 v3su3
dot product dotproduct cross product crossproduct
...
ref vref dot product dotproduct norm getnormsq
