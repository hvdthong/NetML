...
initi state vector dimens
object
integ valueof equat dimens getdimens
...
vec absolut toler vecabsolutetoler vec absolut toler vecabsolutetoler length length
integr except integratorexcept dimens mismatch state vector dimens
absolut toler vector dimens
object
integ valueof length
integ valueof vec absolut toler vecabsolutetoler length


vec rel toler vecrelativetoler vec rel toler vecrelativetoler length length
integr except integratorexcept dimens mismatch state vector dimens
rel toler vector dimens
object
integ valueof length
integ valueof vec rel toler vecrelativetoler length


math ab math max math ab math ab
integr except integratorexcept small integr interv length
object doubl valueof math ab
