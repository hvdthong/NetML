...
param input matrix
param col column select
matrix repres select column

real matrix realmatrix select column selectcolumn real matrix realmatrix col
row dimens getrowdimens col length
