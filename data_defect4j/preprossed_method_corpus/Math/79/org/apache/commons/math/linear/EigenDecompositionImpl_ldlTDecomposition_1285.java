...
decompos shift tridiagon matrix lambda ldl
shift symmetr tridiagon matrix decompos
ldl lower bidiagon matrix unit diagon
diagon matrix method implement
algorithm dhillon' thesi
param lambda shift add matrix decompos
ensur posit definit
param index index row block
param number row block

ldl decomposit ldltdecomposit lambda index
main index lambda
work math ab

fouri
eim1 secondari index
ratio eim1
work fouri ratio ratio math ab
main index lambda eim1 ratio
work fouri math ab
