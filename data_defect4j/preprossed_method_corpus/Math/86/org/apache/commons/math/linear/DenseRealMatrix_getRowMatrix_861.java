...
overrid
dens real matrix denserealmatrix row matrix getrowmatrix row
matrix index except matrixindexexcept

matrix util matrixutil check row index checkrowindex row
dens real matrix denserealmatrix dens real matrix denserealmatrix column
...
block outblock length index outindex
width jwidth
system arraycopi block row irow width jwidth block outblock index outindex
block outblock block block index outblockindex
system arraycopi block row irow width jwidth block outblock width jwidth
index outindex width jwidth

system arraycopi block row irow width jwidth block outblock index outindex width jwidth
index outindex width jwidth
