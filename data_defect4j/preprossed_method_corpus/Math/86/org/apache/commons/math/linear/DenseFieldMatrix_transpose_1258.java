...
dens field matrix densefieldmatrix dens field matrix densefieldmatrix field getfield col ncol row nrow
...
end pend math min start pstart block size column
start qstart block jblock block size
end qend math min start qstart block size row
start pstart end pend
linc end pend start pstart
start qstart start pstart end qend linc
