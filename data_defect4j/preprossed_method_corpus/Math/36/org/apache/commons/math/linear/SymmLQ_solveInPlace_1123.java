...
real linear oper reallinearoper minv real vector realvector
...
check paramet checkparamet minv
...
state state state minv goodb shift
iter linear solver event iterativelinearsolverev event symm event symmlqev state
state beta1
stop
