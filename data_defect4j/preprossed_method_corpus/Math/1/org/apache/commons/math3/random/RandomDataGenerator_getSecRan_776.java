...
return secur random securerandom gener secur random data

creat initi
code system current time milli currenttimemilli system ident hash code identityhashcod seed


secur random securerandom gener secur random data wrap
link random gener randomgener

random gener randomgener sec ran getsecran
sec rand secrand
sec rand secrand random gener factori randomgeneratorfactori creat random gener createrandomgener secur random securerandom
sec rand secrand set seed setse system current time milli currenttimemilli system ident hash code identityhashcod
