...
function control number element contain
arrai valu
arrai function expand intern arrai need

param number element
math illeg argument except mathillegalargumentexcept code code neg

set num element setnumel math illeg argument except mathillegalargumentexcept

index neg thrown error

math illeg argument except mathillegalargumentexcept
local format localizedformat index posit



test num element check arrai
expand accommod number element
start index startindex intern arrai internalarrai length
expand expandto start index startindex
