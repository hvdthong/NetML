...
code len binari byte gener underli
random
binari translat hex digit



param len desir string length
random string
...
random number gener
random gener randomgener ran ran getran

initi output buffer
string builder stringbuild buffer outbuff string builder stringbuild

len random byte
random byte randombyt len
ran byte nextbyt random byte randombyt

convert hex digit
random byte randombyt length
integ integ valueof random byte randombyt


add make interv hex
convers guarante hex digit hex string tohexstr
hex string tohexstr add neg argument
