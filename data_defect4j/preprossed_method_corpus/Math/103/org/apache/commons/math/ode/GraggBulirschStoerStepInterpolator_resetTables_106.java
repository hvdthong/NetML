...
realloc intern tabl
realloc intern tabl order handl
interpol polynom degre
param max degre maxdegre maxim degre handl

reset tabl resett max degre maxdegre
...
pol newpol max degre maxdegre
polynom
system arraycopi polynom pol newpol polynom length
polynom length pol newpol length
pol newpol current state currentst length
...
initi error factor arrai interpol
max degre maxdegre
errfac

errfac max degre maxdegre
errfac length
ip5
errfac ip5 ip5
math sqrt ip5
