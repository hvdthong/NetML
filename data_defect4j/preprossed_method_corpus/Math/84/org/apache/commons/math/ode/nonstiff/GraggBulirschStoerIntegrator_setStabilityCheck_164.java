...
param perform test performtest stabil check perform
check skip
param max iter maxit maxim number iter check
perform number iter reset neg

param max check maxcheck maxim number check iter
number check reset neg
param stabil reduct stabilityreduct stepsiz reduct factor
failur factor reset lower
greater

set stabil check setstabilitycheck perform test performtest
max iter maxit max check maxcheck
stabil reduct stabilityreduct

perform test performtest perform test performtest
max iter maxit max iter maxit max iter maxit
max check maxcheck max check maxcheck max check maxcheck

stabil reduct stabilityreduct stabil reduct stabilityreduct
stabil reduct stabilityreduct
