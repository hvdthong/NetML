...
creat tableau createtableau maxim

creat matrix correct size
list linear constraint linearconstraint constraint normal constraint getnormalizedconstraint
...
matrix index zindex index zindex maxim
...
copi arrai copyarrai object coeffici objectivecoeffici data getdata matrix index zindex num object function getnumobjectivefunct
matrix index zindex width
maxim constant term getconstantterm constant term getconstantterm

restrict neg restricttononneg
matrix index zindex slack variabl offset getslackvariableoffset
...
copi arrai copyarrai constraint coeffici getcoeffici data getdata matrix row


restrict neg restricttononneg
matrix row slack variabl offset getslackvariableoffset
invert coeffieci sum getinvertedcoeffiecientsum constraint coeffici getcoeffici


rh
matrix row width constraint getvalu

slack variabl
constraint relationship getrelationship relationship leq
matrix row slack variabl offset getslackvariableoffset slack var slackvar slack
constraint relationship getrelationship relationship geq
matrix row slack variabl offset getslackvariableoffset slack var slackvar excess


artifici variabl
constraint relationship getrelationship relationship
constraint relationship getrelationship relationship geq
matrix artifici variabl offset getartificialvariableoffset artifici var artificialvar
matrix row artifici variabl offset getartificialvariableoffset artifici var artificialvar
