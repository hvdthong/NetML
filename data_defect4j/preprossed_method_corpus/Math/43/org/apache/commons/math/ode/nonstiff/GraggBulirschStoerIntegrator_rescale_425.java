...
updat scale arrai
param state vector scale
param state vector scale
param scale scale arrai updat shorter state

rescal scale
vec absolut toler vecabsolutetoler
scale length
fast math fastmath max fast math fastmath ab fast math fastmath ab
scale scal absolut toler scalabsolutetoler scal rel toler scalrelativetoler


scale length
fast math fastmath max fast math fastmath ab fast math fastmath ab
scale vec absolut toler vecabsolutetoler vec rel toler vecrelativetoler
