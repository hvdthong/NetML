...
perform symmetri check linear oper
except check fail linear oper
vector method check
...
param linear oper
param candid vector
param candid vector middot
param vector middot
adjoint oper except nonselfadjointoperatorexcept test fail

check symmetri checksymmetri real linear oper reallinearoper
real vector realvector real vector realvector real vector realvector
adjoint oper except nonselfadjointoperatorexcept
dot product dotproduct
dot product dotproduct
epsa mach prec cbrt mach prec
fast math fastmath ab epsa
adjoint oper except nonselfadjointoperatorexcept
adjoint oper except nonselfadjointoperatorexcept
except context exceptioncontext context context getcontext
context set setvalu symm symmlq oper
context set setvalu symm symmlq vector1
context set setvalu symm symmlq vector2
context set setvalu symm symmlq threshold doubl valueof epsa
