...
iter getiter max iter getmaxiter
integ min row minrow
min index minindex tableau width getwidth
integ row min ratio posit minratioposit
tableau num object function getnumobjectivefunct
tableau width getwidth min row minrow row
row tableau basic row getbasicrow
min index minindex
min index minindex
min row minrow row
