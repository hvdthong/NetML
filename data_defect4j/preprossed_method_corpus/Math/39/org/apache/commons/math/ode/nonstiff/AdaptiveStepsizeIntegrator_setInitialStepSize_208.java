...
set initi step size
method user initi posit
step size let integr guess
method call integr
start initi step size estim
integr
param initi step size initialsteps initi step size posit
backward integr provid neg
min max step interv lead integr
ignor comput initi step size

set initi step size setinitialsteps initi step size initialsteps
initi step size initialsteps min step minstep initi step size initialsteps max step maxstep
initi step initialstep

initi step initialstep initi step size initialsteps
