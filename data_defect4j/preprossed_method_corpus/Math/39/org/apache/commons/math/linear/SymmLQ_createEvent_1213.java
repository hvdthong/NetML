...
creat event fire solut process unmodifi
view rh vector current estim solut
return creat event

param state refer current state algorithm
newli creat event

iter linear solver event iterativelinearsolverev creat event createev state state
real vector realvector real vector realvector unmodifi real vector unmodifiablerealvector state

iter linear solver event iterativelinearsolverev event
event iter linear solver event iterativelinearsolverev

serial version uid serialversionuid 3656926699603081076 3656926699603081076l
