...
recomput step
step nbstep math max math ab math round step
step laststep
step start stepstart
step size stepsiz step nbstep
handler reset
step laststep
...
updat needupd
step size stepsiz switch handler switcheshandl event time geteventtim step start stepstart
...
updat needupd
switch function chang step
recomput stepsiz
step nbstep math max math ab math round step start stepstart step
step size stepsiz step start stepstart step nbstep
