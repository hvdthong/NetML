...
param max order maxord maxim order extrapol tabl
maxim order reset order odd
param order control1 ordercontrol1 order control factor factor
reset lower greater
param order control2 ordercontrol2 order control factor factor
reset lower greater

set order control setordercontrol max order maxord
order control1 ordercontrol1 order control2 ordercontrol2

max order maxord max order maxord
max order maxord


order control1 ordercontrol1 order control1 ordercontrol1
order control1 ordercontrol1

order control1 ordercontrol1 order control1 ordercontrol1


order control2 ordercontrol2 order control2 ordercontrol2
