...
trap handler subclass overrid provid trap
function ieee

param type except type flag overflow
param routin divid
param oper operand function
param def trap enabl
param result result deliv
ieee
oper trigger trap

dfp trap type string dfp oper dfp def dfp result
def
