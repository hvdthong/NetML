...
creat kalman filter process measur model
...
column dimens transit matrix match dimens
initi state estim vector
matrix dimens mismatch except matrixdimensionmismatchexcept
matrix dimens fit

kalman filter kalmanfilt process model processmodel process measur model measurementmodel measur
null argument except nullargumentexcept squar matrix except nonsquarematrixexcept dimens mismatch except dimensionmismatchexcept
matrix dimens mismatch except matrixdimensionmismatchexcept
...
state estim stateestim arrai real vector arrayrealvector transit matrix transitionmatrix column dimens getcolumndimens
